...
## Purpose
Keep the project's release version declared once, observable wherever a user can
ask for it, and strictly separate from the PostgreSQL compatibility level that
clients branch on — plus the changelog and tag that mark each release.
