...
- **Docker VM resources:** the benchmark runs six engine containers (arneb and
  ...
  least **16 GB RAM** and **~20 GB free disk** for SF10 (the seed writes ~10 GB
  of Parquet into MinIO; the image adds a few GB). Raise the Docker Desktop /
  OrbStack memory allocation if workers OOM; scale RAM/disk up for SF30.
